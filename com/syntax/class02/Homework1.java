...
public class Homework1 {
	...
	//Create a Java Program (class) and name or PracticeVariables.
	//create variables for all
	//8 primitive Date Types (byte,short, int, long, float, double, char, boolean).
	...
	public static void main(String[] args) {
		...
		long tatiana= 4564678675432345678l;
		...
		char bulat = '$';
		char kamila1 = 'm';
		char kamila2 = 'M';// value kamila1 is not the same with value in kamila
		char metin = ' ';// Im storing space
