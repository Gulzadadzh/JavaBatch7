...
public class Homework {
	...
	public static void main(String[] args) {
		...
		System.out.println("The multiplicztion of 2 numbers " + num1 + " and " + num2
				+ " is equal to " + mult );
		...
		System.out.println("The perimeter of rectangle with width" + width
				+ " and height " + height +  " is aquale to " + perimeter
				+ " and area is " + area);
